...
test_that("traveling saleman works", {
  ...
  t <- c(2, 3, 4, 3, 4, 4)
  d <- c(1, 2, 3, 4, 5, 6)
  out <- TravelingSalesman(s, t, d, 4, 999999, "Christofides")
  expect_equal(out[[1]], c(3, 1, 2, 4))
  expect_equal(out[[2]], 14)
  out <- TravelingSalesman(s, t, d, 4, 999999, "Greedy")
  expect_equal(out[[1]], c(1, 2, 4, 3))
  expect_equal(out[[2]], 14)
  out <- TravelingSalesman(s, t, d, 4, 999999, "Insertion")
  expect_equal(out[[1]], c(1, 2, 3, 4))
  expect_equal(out[[2]], 14)
  out <- TravelingSalesman(s, t, d, 4, 999999, "NearestNeighbor")
  expect_equal(out[[1]], c(3, 1, 2, 4))
  expect_equal(out[[2]], 14)
  out <- TravelingSalesman(s, t, d, 4, 999999, "Opt2")
  expect_equal(out[[1]], c(1, 2, 3, 4))
  expect_equal(out[[2]], 14)
  expect_error(TravelingSalesman(s, t, d, 4, 999999, "abc"), "Invalid")
})
