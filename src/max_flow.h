...
// a graph's edges ' @param arcLowerBound, a vector corresponding to the
// lower-bound capacities of nodes of a graph's edges ' @param arcUpperBound, a
// vector corresponding to the upper-bound capacities of nodes of a graph's
// edges ' @param nodeSupplies, a vector corresponding to the supplies of each
//node of the graph. ' @param numNodes, the number of nodes in the graph '
// @return A list containing three entries: 1) A list corresponding to the flows
// of arcs in the graph, 2) A list of the graph's barrier nodes, and 3) the total
// cost of the flows in the graph, i.e. the maxflow value > NULL

//' Maximum  Flow Algorithms
//' @name Maximum Flow Algorithms
//' @param arcSources, a vector corresponding to the source nodes of a graph's
// edges ' @param arcTargets, a vector corresponding to the destination nodes of
// a graph's edges ' @param arcDistances, a vector corresponding to the
// capacities of nodes of a graph's edges ' @param sourceNode, the source node '
//@param destinationNode, the destination node ' @param numNodes, the number of
// nodes in the graph ' @return A list containing three entries: 1) A list
// corresponding to the flows of arcs in the graph, and 2) A list of cut-values
// of the graph's nodes. > NULL

//' @rdname Maximum-Flow-Algorithms-2
//' @description `PreflowRunner` runs the Preflow Algorithm to calculate the
// maximum flow. ' @export
// [[Rcpp::export]]
...
//' @rdname Maximum-Flow-Algorithms
//' @description `EdmondsKarpRunner` runs the EdmondsKarp Algorithm to calculate
// the maximum flow.
// [[Rcpp::export]]
