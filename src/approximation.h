...
// a List with 1) the clique size, and 2) the members of the clique > NULL

//' @rdname Approximation-Algorithms
//' @description `GrossoLocatelliPullanMcRunner` runs the Grosso, Locatelli, and
// Pullan for solving the maximum clique problem ' @export
// [[Rcpp::export]]
