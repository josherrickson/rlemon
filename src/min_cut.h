...
// Calculates a Gomory-Hu Tree and returns a list containing three entries: 1) A
// list of predecessor nodes of each node in the graph, and 2) A list of weights
// of the predecessor edge of each node, and 3) A list of distances from the
// root node to each node. > NULL
...
// a graph's edges ' @param arcWeights, a vector corresponding to the weights of
// a graph's edges ' @param numNodes, the number of nodes in the graph ' @return
// A list containing three entries: 1) The value of the minimum cut in the
// graph, and 2) A list of nodes in the first partition, and 3) A list of nodes
// in the second partition. > NULL

//' @rdname Minimum-Cut-Algorithms
//' @description `NagamochiIbarakiRunner` runs the Nagamochi-Ibaraki Algorithm
// to calculate the minimum cut. ' @export
// [[Rcpp::export]]
...
//' @rdname Minimum-Cut-Algorithms
//' @description `HaoOrlinRunner` runs the Hao-Orlin Algorithm to calculate the
// minimum cut. ' @export
// [[Rcpp::export]]
...
//' @description `GomoryHuTreeRunner` runs the Gomory-Hu Algorithm to calculate
// a rooted Gomory Hu Tree. ' @export
// [[Rcpp::export]]
