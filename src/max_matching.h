...
// a graph's edges ' @param arcWeights, a vector corresponding to the weights of
// a graph's edges ' @param numNodes, the number of nodes in the graph ' @return
// A list containing two entries: 1) The matching value, 2) The edges of the
// final graph, in a List of List of (node, node) pairs > NULL

//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumWeightPerfectMatchingRunner` solves the Maximum-Weight
...
//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumWeightFractionalPerfectMatchingRunner` solves the
// Maximum-Weight Fractional Perfect Matching Problem
// [[Rcpp::export]]
...
//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumWeightFractionalMatchingRunner` solves the
// Maximum-Weight Fractional Matching Problem
// [[Rcpp::export]]
...
//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumWeightMatchingRunner` solves the Maximum-Weight
// Matching Problem
// [[Rcpp::export]]
...
//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumCardinalityMatchingRunner` solves the Maximum
...
Rcpp::List MaximumCardinalityMatchingRunner(std::vector<int> arcSources,
  ...
  // Returns: One std::vector, which contains the minimum distances from the
  // start node to each of the nodes, with "-1" used as a placeholder to
  // indicates the target and source and disjoint
  ListGraph g;
  std::vector<Node> nodes;
  for (int i = 0; i < numNodes; ++i) {
    Node n = g.addNode();
...
//' @rdname Maximum-Matching-Algorithms
//' @description `MaximumCardinalityFractionalMatchingRunner` solves the
// Maximum-Cardinality Fractional Matching Problem
// [[Rcpp::export]]
