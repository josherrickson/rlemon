...
// a graph's edges ' @param arcCapacities, a vector corresponding to the
// capacities of nodes of a graph's edges ' @param arcCosts, a vector
// corresponding to the capacities of nodes of a graph's edges ' @param
// nodeSupplies, a vector corresponding to the supplies of each node ' @param
// numNodes, the number of nodes in the graph ' @return A list containing three
// entries: 1) A list corresponding to the flows of arcs in the graph, 2) A list
// of potentials of the graph's nodes, and 3) the total cost of the flows in the
// graph, i.e. the mincostflow value > NULL

//' @rdname Minimum-Cost-Flow-Algorithms
//' @description `CycleCancellingRunner` runs the Cycle-Cancelling Algorithm to
...
//' @rdname Minimum-Cost-Flow-Algorithms
//' @description `CapacityScalingRunner` runs the Capacity-Scaling Algorithm to
// calculate the minimum cost flow.
// [[Rcpp::export]]
...
//' @rdname Minimum-Cost-Flow-Algorithms
//' @description `CostScalingRunner` runs the Cost-Scaling Algorithm to
// calculate the minimum cost flow.
// [[Rcpp::export]]
...
//' @rdname Minimum-Cost-Flow-Algorithms
//' @description `NetworkSimplexRunner` runs the Network-Simplex Algorithm to
// calculate the minimum cost flow.
// [[Rcpp::export]]
