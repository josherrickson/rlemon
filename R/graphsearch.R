...
##'   "Bfs", "Dfs". Bfs (Breadth First Search) is the default; see
##'   <http://lemon.cs.elte.hu/pub/doc/1.3.1/a00608.html> for details
##'   on the differences.
...
##' @param arcSources Vector corresponding to the source nodes of a graph's edges
##' @param arcTargets Vector corresponding to the destination nodes of a graph's edges
##' @param arcCapacities Vector corresponding to the distances of a graph's edges
##' @param numNodes The number of nodes in the graph
##' @param startNode Optional start node of the path
##' @param algorithm Which algorithm to run. Choices include
