...
##' @export
MinSpanningTree <- function(arcSources, arcTargets, arcDistances, numNodes, algorithm="Kruskal") {
...
##' @param algorithm Which algorithm to run. Choices include
##'   "MinCostArborescence"
##'   where "MinCostArborescence" is the default.
##'   See <http://lemon.cs.elte.hu/pub/doc/1.3.1/a00610.html> 
##'   for details on the differences.
...
##' @export
MinCostArborescence <- function(arcSources, arcTargets, arcDistances, sourceNode, numNodes, algorithm="MinCostArborescence") {
