##' Runs algorithms for calculating maximum weighted matching in graphs and bipartite graphs.
##'
##' @title MaxMatching
...
##'   "MaxWeightedMatching", "MaxWeightedPerfectMatching", "MaxWeightedFractionalMatching", "MaxWeightedPerfectFractionalMatching"
...
##' @export
MaxMatching <- function(arcSources, arcTargets, arcWeights=NULL, numNodes, algorithm="MaxWeightedMatching") {
...
##' Runs algorithms for calculating maximum cardinality matching in graphs and bipartite graphs.
##'
...
##' @param numNodes The number of nodes in the graph
##' @param algorithm What algorithm you want to run. Choices include
##'   "MaxMatching", "MaxFractionalMatching"
##'   where "MaxMatching" is the default.
##'   See <http://lemon.cs.elte.hu/pub/doc/1.3.1/a00615.html> 
##'   for details on the differences.
##' @return A list containing two entries: 1) The matching value, 2) The edges of the final graph, in a List of List of (node, node) pairs
##' @export
