##' Runs mincut algorithms on graphs. NagamochiIbaraki calculates the min cut value in undirected graphs. HaoOrlin calculates the min cut value in directed graphs.
##'
##' @title MinCut
