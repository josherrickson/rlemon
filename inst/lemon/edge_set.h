...
template <typename GR> class ListArcSetBase {
public:
...
protected:
  ...
  struct ArcT {
    ...
    ArcT() : next_out(-1), next_in(-1), prev_out(-1), prev_in(-1) {}
  };
...
public:
  ...
  template <typename V> class NodeMap : public GR::template NodeMap<V> {
  ...
  public:
    ...
    template <typename CMap> NodeMap &operator=(const CMap &cmap) {
...
template <typename GR> class ListEdgeSetBase {
public:
  typedef typename GR::Node Node;
  typedef typename GR::NodeIt NodeIt;
...
template <typename GR> class SmartArcSetBase {
public:
  typedef typename GR::Node Node;
  typedef typename GR::NodeIt NodeIt;
...
template <typename GR> class SmartEdgeSetBase {
public:
  typedef typename GR::Node Node;
  typedef typename GR::NodeIt NodeIt;
